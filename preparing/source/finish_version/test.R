...
# user_item_ratings_t <- t(user_item_ratings)
# 
# rating <- as(user_item_ratings_t, "realRatingMatrix")
# 
# nrow(rating)
# ncol(rating)
# View(as(rating, "matrix"))
# 
...
# 
# r <- Recommender(rating[1:5], method = "UBCF") # POPULAR, UBCF
# r
# # rating_eval <- evaluationScheme(rating, method="split", train=0.7, given=1)
# # predict(r, getData(rating_eval, "known"), type="ratings")
# 
# names(getModel(r))
# getModel(r)$description
# getModel(r)$data
# recom <- predict(r, rating[4], n=15, type="topNList") 
